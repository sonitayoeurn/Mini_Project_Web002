        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                  <Image unoptimized width={500} height={500} src="/images/logo.png" className="mr-3 w-16 h-16" alt="Istad Logo" />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">ISTAD</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" className="hover:underline">Selling Product</a>
                      </li>
                  </ul>
              </div>
              <div>
